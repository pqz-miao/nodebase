...
const formSchema = z.object({
    ...
    body: z.string().optional(), // TODO: .refine()
});
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <Form {...form}>
                    <form
                        onSubmit={form.handleSubmit(handleSubmit)} className="space-y-8 mt-4"
                    >
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Use this name ton reference the result in other nodes:{" "}{`{{${watchVariableName}.httpResponse.data}}`}.
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <FormControl>
                                            <Textarea
                                                placeholder={
                                                    '{\n "userId": "{{variables.userId}}",\n "details": {{json variables.userDetails}}\n}'
                                                }
